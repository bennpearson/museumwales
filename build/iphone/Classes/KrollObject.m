...
//@interface museumwalesObject : NSObject
//@end

@interface museumwalesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[museumwalesObject class]])
		{
			for (NSString *key in [[(museumwalesObject*)o modules] allKeys])
			{
