...
// in simulator we redefine to format for museumwales Developer console
...
{\
	NSString * exceptionName = [@"org.museumwales." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.museumwales";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UImuseumwalesNativeItemNone = -1, 
	UImuseumwalesNativeItemSpinner = -2,
	UImuseumwalesNativeItemProgressBar = -3,
	
	UImuseumwalesNativeItemSlider = -4,
	UImuseumwalesNativeItemSwitch = -5,
	UImuseumwalesNativeItemMultiButton = -6,
	UImuseumwalesNativeItemSegmented = -7,
	
	UImuseumwalesNativeItemTextView = -8,
	UImuseumwalesNativeItemTextField = -9,
	UImuseumwalesNativeItemSearchBar = -10,
	
	UImuseumwalesNativeItemPicker = -11,
	UImuseumwalesNativeItemDatePicker = -12,
	
	UImuseumwalesNativeItemInfoLight = -13,
	UImuseumwalesNativeItemInfoDark = -14,
	
	UImuseumwalesNativeItemDisclosure = -15,
	
	UImuseumwalesNativeItemContactAdd = -16
};
